...
class Utility(
	...
	@bridge_option("member", required=False, default=None)
	...
	@bridge_option("data", description="choice1, choice2, choice3 ... (random choice) | any number (random number choice)", required=True)
	...
	@bridge_option("mode", required=True, choices=["encode", "decode"])
	...
	@bridge_option("data", description='example: 0097 or 97 (small letter "a") / • (U+2022)', required=True)
	@bridge_option("get", required=True, choices=["character", "unicode"])
